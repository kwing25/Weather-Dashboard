...
//   var endPoint = `http://api.openweathermap.org/data/2.5/weather?q=${searchValue}&appid=52295644386b9059a3d034279446c259`;
//   fetch(endPoint)
//     .then(function(response) {
//       return response.json();
...
//     })
//   }
//   document.querySelector("#search-btn").addEventListener("click", getSearchValue)
// })